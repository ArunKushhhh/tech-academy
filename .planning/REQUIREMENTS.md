...
- [ ] **UX-02**: Ensure all animations (GSAP/Motion) are performant and pause gracefully on mobile if necessary.
- [ ] **UX-03**: Export as a static site (HTML/CSS/JS) for extremely fast load times.

## v2 Requirements (Deferred)
- Interactive course filtering by age/level
- Dynamic blog or article CMS

## Out of Scope
- [Authentication] — Not a student portal, no user sign-ins needed.
- [Database/Backend] — Keep it simple. Form submissions should route via an external serverless provider (Web3Forms/Resend).
